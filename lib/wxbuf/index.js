...
import { Watcher } from './src/hookWatcher'
import { builtInHooks } from './src/builtInHooks'
import { storageCache } from './src/storageCache'
import { renderViewAsync } from './src/renderAsync'
...
const jumpPage = function (fn, option) {
  const absoluteURL = path.resolve(getCurrentPage().route, option.url)
